...
class ModelConfig:
    def __init__(self):
        ...
        if os.path.isdir(self.LAMA_MODEL_DIR): merge_big_file_if_not_exists(self.LAMA_MODEL_DIR, 'bit-lama.pt')
        if os.path.isdir(self.PROPAINTER_MODEL_DIR): merge_big_file_if_not_exists(self.PROPAINTER_MODEL_DIR, 'ProPainter.pth')
        if os.path.isdir(self.DET_MODEL_DIR): merge_big_file_if_not_exists(self.DET_MODEL_DIR, 'inference.onnx')
